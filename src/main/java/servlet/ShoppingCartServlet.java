...
import exception.BeanNameNotFound;
...
public class ShoppingCartServlet extends HttpServlet{
    ...
    private String beanName="java:global/ShoppingCartImpl!bean.ShoppingCart";
    ...
    private ShoppingCart getBean(String shoppingCart) throws ServletException {
        try {
            InitialContext initialContext = new InitialContext();
            return (ShoppingCart)initialContext.lookup(shoppingCart);
